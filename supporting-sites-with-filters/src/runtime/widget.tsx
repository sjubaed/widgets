...
import { Radio, Label, Checkbox, Dropdown, DropdownButton, DropdownMenu, DropdownItem, MultiSelect } from "jimu-ui";
...
import Item from "jimu-ui/basic/lib/item-selector/components/item-selector/item";
      ...
      >
        {this.props.hasOwnProperty("useMapWidgetIds") &&
          ...
          <div style={{ margin: "0 auto" }}>
            ...
            isSubMenuItem
            >
              <DropdownButton>{"Food Banks and Distribution Centers"}</DropdownButton>
              <DropdownMenu>
                <DropdownItem>
                  {"All"}
                </DropdownItem>
